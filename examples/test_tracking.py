...
print("\n1. CHAT")
print("-" * 70)
response = jugglerr.chat([{"role": "user", "content": "Say hello"}])
...
print("\n2. EMBEDDINGS")
print("-" * 70)
embeddings = jugglerr.embed(["Hello"])
